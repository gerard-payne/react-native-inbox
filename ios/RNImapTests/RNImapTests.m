...
- (void)testDownloadEmails {
    ...
    XCTestExpectation *expectation = [self expectationWithDescription:@"downloadEmails"];
    
    [self.module downloadEmails:options resolver:^(id result) {
